        ...
        <div class="col-12 col-lg-9 col-xl-9">
          <div class="card shadow-2-strong card-registration" style="border-radius: 15px;">
            <div class="card-body p-4 p-md-5">
              <div class="d-flex justify-content-between mb-4 pb-2 pb-md-0 mb-md-5">
              ...
              <form method="post" action="/user_update" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-4">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="gender" value='0' id="femaleGender" value="option1" <?php if (isset($users)) {
                                                                                                                                if ($users['u_gender'] == '0') echo "checked";
                                                                                                                              } ?> />
                      <label class="form-check-label" for="femaleGender">Male</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="gender" value='1' id="maleGender" value="option2" <?php if (isset($users)) {
                                                                                                                              if ($users['u_gender'] == '1') echo "checked";
                                                                                                                            } ?> />
                      <label class="form-check-label" for="maleGender">Female</label>
                    </div>

                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="gender" value='2' id="otherGender" value="option3" <?php if (isset($users)) {
                                                                                                                              if ($users['u_gender'] == '2') echo "checked";
                                                                                                                            } ?> />
                ...
                <div class="mt-4 pt-2 d-flex justify-content-between align-items-center float-start">
                  <a href="/profile" class="btn btn-warning btn-lg text-white">Back</a>
                </div>
